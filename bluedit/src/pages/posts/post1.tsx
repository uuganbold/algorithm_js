                ...
                <div className="row ml-1">
                    ...
                    <div className="card h-300">
                        ...
                        <div className="card-body-custom">
                            <h4> <a href="/posts/post1" style={{ color: "#3E3E3E" }}>To the try hard LC peoples </a></h4>
                        ...
                        <div className="media-comment">
                                <div className="empty-space">
                                    ...
                                    <div className="lineholder">
                                            ...
                                            <div className="comment-box">
                                                 <p className="mt-0"><a href="">uuganbold</a></p> 
                                                Congrats rayyanshaji. We are all so proud of you. LC does help and I am working on it daily. I almost do about
                                                        10 easy problems and 3-4 medium problems a day. I've been applying to a lot of companies and trying my best to 
                                                        pass their interviews. Thanks so much for your honest post.
                                ...
                                <div className="media-comment mt-3" style={{ paddingLeft: '19px' }}>    
                                    ...
                                    <div className="lineholder">
                                                ...
                                                <div className="comment-box">    
                                                    <p className="mt-0"><a href="">weizhang</a></p>
                                                    Although LC might seem to work. It might have only worked for you because the same companies use the SAME questions
                                                    from LeetCode for their interviews. I am not trying to hate on LeetCode but just trying to state some realistic facts of possibilities.    
                                                   </div>
